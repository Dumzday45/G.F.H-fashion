...
const PRODUCTS = [
  ...
  { id: 80, name: "Nig made sundress", price: 8000, category: "women", icon: "hanger", image: "images/78.jpg" },
  { id: 81, name: "Nig made top", price: 2500, category: "women", icon: "hanger", image: "images/79.jpg" },
  { id: 82, name: "Nig made sundress", price: 6500, category: "women", icon: "hanger", image: "images/80.jpg" },
  { id: 83, name: "Luxury quality loafers", price: 10000, category: "footwear", icon: "footwear", image: "images/81.jpg" },
  { id: 84, name: "Quality loafers", price: 13000, category: "footwear", icon: "footwear", image: "images/82.jpg" },
  { id: 85, name: "Quality Thrift gown", price: 3000, category: "women", icon: "hanger", image: "images/83.jpg" },
  { id: 86, name: "Quality Thrift jeans size 26-28", price: 6000, category: "women", icon: "hanger", image: "images/84.jpg" },
  { id: 87, name: "Quality joggers", price: 8000, category: "women", icon: "hanger", image: "images/85.jpg" },
  { id: 88, name: "Quality Thrift gown", price: 4000, category: "women", icon: "hanger", image: "images/86.jpg" },
  { id: 89, name: "Nig made bag", price: 3500, category: "bags", icon: "bags", image: "images/87.jpg" },
  { id: 90, name: "Quality Throft cooperate gown", price: 3500, category: "women", icon: "hanger", image: "images/88.jpg" },
  { id: 91, name: "Quality nig made bag", price: 7500, category: "bags", icon: "hanger", image: "images/89.jpg" },
  { id: 92, name: "Nig made top", price: 4000, category: "women", icon: "hanger", image: "images/90.jpg" },
  { id: 93, name: "Quality Thrift jacket", price: 3000, category: "dresses", icon: "hanger", image: "images/91.jpg" },
  { id: 94, name: "Quality nig made bag", price: 6000, category: "bags", icon: "hanger", image: "images/92.jpg" },
  { id: 95, name: "Easy wear thrift gown", price: 2000, category: "women", icon: "hanger", image: "images/93.jpg" },
  { id: 96, name: "Nig made skirt", price: 4500, category: "women", icon: "hanger", image: "images/94.jpg" },
  { id: 97, name: "Luxury Quality rubber bag", price: 8500, category: "bags", icon: "hanger", image: "images/95.jpg" },
  { id: 98, name: "Quality joggers", price: 8000, category: "women", icon: "hanger", image: "images/96.jpg" },
  { id: 99, name: " Luxury Quality rubber bag", price: 8500, category: "bags", icon: "hanger", image: "images/97.jpg" },
];
